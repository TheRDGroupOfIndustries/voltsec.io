...
import { CreateMailAction } from "@/core/server/createMail";
...
export default function CreateMail({ user }: { user: User | undefined }) {
  ...
  return (
    <Form {...form}>
      <div className="p-1.5 flex flex-row justify-start items-center">
        <Link href="/dashboard/helpdesk/inbox">
          <ArrowLeft />
        </Link>
        <h2 className="text-xl font-bold pl-2 py-2">Create Mail</h2>
