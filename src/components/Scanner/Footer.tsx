    ...
    <footer className="m-0 bg-gradient-to-br from-blue-700 via-blue-500 to-blue-700 p-5 py-10">
        ...
        <div className="grid grid-cols-2 gap-2 p-1 sm:grid-cols-4 sm:gap-1">
          ...
          <div className="p-4">
            ...
            <ul className="text-gray-200">
              <li className="mb-2">
                <a
                  href="mailto:Voltsec.io@therdgroupofindustries.com"
              ...
              <li className="mb-2">
                <a href="phone:12346567885" className="hover:underline ">
                  Phone
                </a>
              </li>
              ...
              <li className="mb-2">
                <a
                  href="https://therdgroupofindustries.com"
                  className="hover:underline "
                >
                  Website
                </a>
      ...
      <div className="p-2 sm:flex sm:items-center sm:justify-between">
        <span className="text-sm  text-gray-300 sm:text-center">
          Copyright © {new Date().getFullYear()}. Voltsec.io™ | The RD Group Of
          Industries Reserves All Rights.
        </span>
        <div className="mt-4 flex space-x-5 pr-10 sm:mt-0 sm:justify-center">
          ...
          <a
            href="https://twitter.com/Voltsec_io"
            className="text-gray-100  hover:text-blue-600"
          >
            <svg
              className="h-5 w-5"
          ...
          <a
            href="https://github.com/VotSec-io"
            className="h text-gray-100 hover:text-blue-600"
          >
            <svg
              className="h-5 w-5"
              fill="currentColor"
